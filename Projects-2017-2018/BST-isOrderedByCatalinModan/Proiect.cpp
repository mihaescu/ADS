    ...
    do {
        ...
        switch( choice ) {
            ...
            case 9: {
                    ...
                    if( root != NULL ) {
                        printf( "\n Boundedness values:" );
                        //Readd the desired boundedness values
                    ...
                    //Else start the tasks
                       ...
                       //Continue reading while there is something to read
                        while( !feof( fp ) ) {
                            ...
                            //"V" requires the user to manually enter the boundedness values
                            } else if( option == 'V' ) {
                                //Check if the BST is empty
                                if( root != NULL ) {
                                    //IF not, ask the user to input values
                                    printf( "\n Insert values for minimum and maximum:" );
                                    //Red them
                                    scanf( "%d %d", &minimum, &maximum );
                                    //Retrieve the maximum and minimum
                                    g_maximum = getMax( root );
                                    g_minimum = getMin( root );
